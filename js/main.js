...
new (accordion_js__WEBPACK_IMPORTED_MODULE_0___default())('.faq__accordion', {
  duration: 400,
  showMultiple: false,
...
const enableScroll = () => {
  ...
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].bodyEl.removeAttribute('data-position'); // vars.htmlEl.style.scrollBehavior = 'smooth';
};
